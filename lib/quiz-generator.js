 ...
 *
 * Reaproveita `generateWithFallback` de lib/article-generator.js — a mesma
 * cadeia Groq → OpenRouter → Gemini já usada para gerar os artigos do blog.
 * Ou seja: zero configuração nova é necessária além das chaves que já
 * existem em .env.local (GROQ_API_KEY etc.).
 *
