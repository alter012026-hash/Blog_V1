...
- Ao final do artigo, inclua uma seção "## Fontes" listando cada fonte usada, uma por linha, no formato "- Nome da fonte: link":
...
- Ao final do artigo, inclua uma linha separada: "Fonte: ${newsFact.source || "veículo de notícias"}" seguida do link ${newsFact.link || ""}, para dar transparência e permitir que o leitor confira o edital original
`
    : "";
