...
// Mapa de todos os providers disponíveis. A ORDEM padrão (Groq primeiro)
// é a usada pela geração de artigos — Groq tem o tier grátis mais generoso,
// então é onde o volume de posts deve recair.
//
...
// `providerOrder` próprio — ver 2º parâmetro abaixo. Groq nem precisa estar
...
async function generateWithFallback(prompt, providerOrder = ["Groq", "OpenRouter", "Gemini"]) {
